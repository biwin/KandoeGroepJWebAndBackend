...
var UserLogin = (function () {
    ...
    UserLogin.prototype.onLoginSubmit = function () {
        ...
        if (this.button == "login") {
            ...
            this.service.registerUser(this.usernameString, this.passwordString, this.emailString, "web").subscribe(function (token) {
                if (_this.emailString == null || _this.emailString == "") {
                    _this.errorInfo = "Voor te registreren dient u een email adres mee te geven";
                }
                else {
                    if (token != null && token != "") {
                        if (token._body == "nope")
