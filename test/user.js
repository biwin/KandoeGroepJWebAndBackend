...
describe('UserManager', function () {
    ...
    describe('getAllUsers', function () {
        var users = [new user_1.User('Jasper', 'jasper.catthoor@student.kdg.be', 'password', 'web'),
            new user_1.User('Jan', 'jasper.catthoor@student.kdg.be', 'password', 'web'),
            new user_1.User('Enio', 'jasper.catthoor@student.kdg.be', 'password', 'web')];
        before(function (done) {
            this.timeout(0);
            try {
